...
export interface PluginMyStrapiPluginTodo extends Schema.CollectionType {
...
export interface PluginOtpPluginOtplogin extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::otp-plugin.otplogin': PluginOtpPluginOtplogin;
